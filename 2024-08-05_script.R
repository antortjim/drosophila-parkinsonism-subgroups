...
#1:setting workspace
  ...
  DATA_DIR <- paste("L:/GBW-0138_PAVER/Natalie/C2_ethoscope/ethoscope_results/ID",ID, sep="")
...
dt <- scopr::load_ethoscope(
  ...
  curate=FALSE,
  #cache = "C:/Users/u0122996/Documents/cache",
  cache = "L:/GBW-0138_PAVER/Natalie/C2_ethoscope/ethoscope_results/cache",
  verbose=TRUE,
...
#A9 morning anticipation = (a-b)/(a+b),
  ...
  inverted_day_diff<-1/(stop_day_experiment-(start_day_experiment+1))
